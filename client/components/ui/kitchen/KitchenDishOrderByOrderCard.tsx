...
const KitchenDishOrderByOrderCard: React.FC<KitchenDishOrderProps> = memo(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <TimeDifferentAndDishQuantity dishOrder={dishOrder} theme={theme} />
        </Surface>
      </TouchableOpacity>
    );
  }
...
export default KitchenDishOrderByOrderCard;
